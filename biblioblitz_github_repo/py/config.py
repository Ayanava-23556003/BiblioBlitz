...
# ── Country data ─────────────────────────────────────────────────────────────
# Single source of truth: ISO 3166-1 alpha-2 → country name (249 entries)
_ISO2_NAME = {
...
COUNTRIES = ["Global (All Countries)"] + sorted(_ISO2_NAME.values())
COUNTRY_ISO2 = {name: code for code, name in _ISO2_NAME.items()}
