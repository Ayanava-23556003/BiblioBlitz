...
pyinstaller ^
    ...
    --hidden-import py ^
    --hidden-import py.config ^
    --hidden-import py.utils ^
    --hidden-import py.dialogs ^
    --hidden-import py.splash ^
    --hidden-import py.app ^
    --hidden-import py.tabs ^
    --hidden-import py.tabs.tab_acquisition ^
    --hidden-import py.tabs.tab_statistics ^
    --hidden-import py.tabs.tab_slr ^
    --hidden-import py.engine ^
    --hidden-import py.engine.geo ^
    --hidden-import py.engine.journals ^
    --hidden-import py.engine.downloader ^
    --hidden-import py.engine.trends ^
    --clean ^
    --noconfirm ^
    "%~dp0main.py"
